...
resource "null_resource" "main" {
  ...
  provisioner "local-exec" {
    command = "sleep 10 ; pip3.11 install ansible ; ansible-pull -U https://github.com/B59-CloudDevOps/learn-ansible.git -e env=${var.env} -e component=${var.name} expense-pull.yaml"
